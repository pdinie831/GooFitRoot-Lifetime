...
//   pad2->SetLeftMargin(0.15); 
    ...
    Char_t    InputFileName[300] = "test-ntupla-MC.root";
...
//
  ...
  Variable* sigma1 = new Variable("sigma1",1.50263e-02,XStepMinuit, 0., 1.);
  Variable* sigma2 = new Variable("sigma2",3.25084e-02,XStepMinuit, 0., 1.);
 ...
 */  
  ...
  Variable* wg1 = new Variable("wg1",6.31918e-01, 0., 1.);
  Variable* wg2 = new Variable("wg2",0.5 , 0., 1.);
  Variable* signalYield = new Variable("signalYield", 400000,      0., 1000000.);
  Variable* bckgYield   = new Variable("bckgYield"  ,  13000,      0.,  100000.);
...
//  SimpleCheby2Pdf* Test  = new SimpleCheby2Pdf("Test", xMass, p0, p1,VMinSign,VMaxSign);
  SimpleCheby2Pdf bckgMass("bckgMass", xMass, p0, p1,VMinSign,VMaxSign);
...
//==============================================================================
     ...
     Variable* cTau     = new Variable("cTau"  ,1./(1.638 *c_const), 0., 50.);
     Variable* tauSB1   = new Variable("tauSB1",2.69964e+01, 0., 50.);
...
//  Variable* meanGaussianErrSign1   = new Variable( "meanGaussianErrSign1"      ,0.0013  ,SXMin, SXMax);
//  Variable* sigmaGaussianErrorSign1= new Variable( "sigmaGaussianErrorSign1"   ,0.0003  ,0.00001, SXMax);
...
//   Variable* tauErrBckg   = new Variable("tauErrBckg",2100,0.,0., 10000.);
  ...
  Variable* meanGaussianErrSign1    = new Variable( "meanGaussianErrSign1"      ,1.18037e-03 ,0.0001, SXMax);
  Variable* sigmaGaussianErrorSign1 = new Variable( "sigmaGaussianErrorSign1"   ,2.57472e-04 ,0.0001, SXMax);

  Variable* meanGaussianErrSign2    = new Variable( "meanGaussianErrSign2"     ,1.58758e-03 ,0.0001, SXMax);
  Variable* sigmaGaussianErrorSign2 = new Variable( "sigmaGaussianErrorSign2"  ,2.37290e-04 ,0.0001, SXMax);
  ...
  Variable* tauErrSign   = new Variable("tauErrSign" ,2.67212e+03,1000., 5000.);
  Variable* tauErrSign2  = new Variable("tauErrSign2",4.95119e+03,1000., 10000.);
  Variable* tauErrBckg   = new Variable("tauErrBckg" ,1.71224e+03,1000., 10000.);
...
//    ExpGausProdBPdf* DecayBp	= new ExpGausProdBPdf("DecayBp"    , xcTau, xScTau, meanRes    , cTau  , sigmaGaussianErrorSign1" meanGaussianErrSign1,tauErrSign,
//    XMinV,XMaxV,SXMinV,SXMaxV);
      ExpGausProdBPdf* DecayBp1	= new ExpGausProdBPdf("DecayBp1"    , xcTau, xScTau, meanRes    , cTau  , sigmaGaussianErrorSign1, meanGaussianErrSign1,tauErrSign,
      XMinV,XMaxV,SXMinV,SXMaxV);
//  ExpGausProdEffiBPdf* DecayBp1	= new ExpGausProdEffiBPdf("DecayBp1"    , xcTau, xScTau, meanRes    , cTau  , sigmaGaussianErrorSign1" meanGaussianErrSign1,tauErrSign,
//  XMinV,XMaxV,SXMinV,SXMaxV);
...
//     XMinV,XMaxV,SXMinV,SXMaxV);
      ExpGausProdBPdf* DecayBp2	= new ExpGausProdBPdf("DecayBp2"    , xcTau, xScTau, meanRes    , cTau  , sigmaGaussianErrorSign2, meanGaussianErrSign2,tauErrSign2,
      XMinV,XMaxV,SXMinV,SXMaxV);
//  ExpGausProdEffiBPdf* DecayBp2	= new ExpGausProdEffiBPdf("DecayBp2"    , xcTau, xScTau, meanRes    , cTau  , sigmaGaussianErrorSign2, meanGaussianErrSign2,tauErrSign2,
//  XMinV,XMaxV,SXMinV,SXMaxV);
//  ExpGausProdEffiBPdf* pdfFitBckg1 = new ExpGausProdEffiBPdf("pdfFitBckg1", xcTau, xScTau, meanResBckg, tauSB1, sigmaGaussianErrorBckg, meanGaussianErrBckg,tauErrBckg,
//  XMinV,XMaxV,SXMinV,SXMaxV);
...
//     XMinV,XMaxV,SXMinV,SXMaxV);
      ExpGausProdEffiBPdf* pdfFitBckg2 = new ExpGausProdEffiBPdf("pdfFitBckg2", xcTau, xScTau, meanResBckg, tauSB2, sigmaGaussianErrorBckg, meanGaussianErrBckg,tauErrBckg,
      XMinV,XMaxV,SXMinV,SXMaxV);
...
//   bkg_STau_Hist.Write();
  ...
  c2->Write();
  c3->Write();
  char PDFNameMass[50] = "Bp-Mass-2016_MC.pdf";
  char PDFNamecTau[50] = "Bp-cTau-2016_MC.pdf";
  char PDFNameReso[50] = "Bp-Reso-2016_MC.pdf";
  char testo[130] ;
